def main():
    ...
    chemical_mass = float(input("Please Enter the Mass of a Chemical in Grams:"))
    ...
    p_formula = parse_formula(chemical_formula,periodic_table )
    # Call the compute_molar_mass function to compute the
    # molar mass of the molecule from the compound list.
    c_mass = compute_molar_mass(p_formula, periodic_table)
    # Compute the number of moles in the sample.
    number_of_moles = chemical_mass / c_mass
    # Print the molar mass.
    print(f"{c_mass:.5f} grams per mole")
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for key, value in symbol_quantity_list:
        ...
        mole_weight = chem_symbol[ATOMIC_MASS_INDEX] * quantity
